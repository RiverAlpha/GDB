...
rate = pd.read_csv("prediction_DALYs_Rate_Male.csv")
case = pd.read_csv("prediction_DALYs_Num_Male.csv")
...
ax1.set_xlabel('Year')
ax1.set_ylabel('Number (per 100,000)', color='black')
...
ax2.set_ylim(0, 7)
ax2.set_ylabel('Rate (per 100,000)', color='black')
...
# 添加标题和图例
plt.title('Male DALYs')
# fig.legend(loc='upper right', bbox_to_anchor=(1, 1), bbox_transform=ax1.transAxes)

plt.savefig("Prediction_DALYs_Male.png")
plt.show()